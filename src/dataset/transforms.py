...
from src.dataset.kp_preprocess import get_2d3d_perspective_transform
...
class MeshPerspectiveTransform(object):
    ...
    def __call__(self, results):
        ...
        # Convert rotation from degrees to radians for get_2d3d_perspective_transform
        r_rad = np.deg2rad(r)
        new_K, trans_matrix_2d, trans_matrix_3d = get_2d3d_perspective_transform(K, c, s, r_rad, self.image_size[0])
        ...
        results["K"] = new_K
        results['trans_matrix_2d'] = trans_matrix_2d  # Save for bb2img_trans
